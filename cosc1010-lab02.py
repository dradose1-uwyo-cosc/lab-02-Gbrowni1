...
# Lab 02
# Lab Section: 10  
# Sources: Google - remembering how to make a title case.
# People worked with: Ben Mathis
...
V_school = "University of Wyoming"
V_date = "1886"
print(f"The {V_school} was founded in {V_date}")
